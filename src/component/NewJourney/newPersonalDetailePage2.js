...
import styles from "./newPersonalDetailePage2.module.css";
...
function NewPersonalDetailePage2({
  mainFormData = {},
  setActiveContainer,
  setFormData,
}) {
  ...
  const handleBoxClick = (inputRef) => {
    ...
    const peremailRef = useRef(null);
    const dobRef = useRef(null);

  const { uid, setUId, isWebsocketConnectionEstablished, setIsWebsocketConnectionEstablished} = useContext(UIDContext);//new11
  ...
  const {
        ...
        payloadForSelect,
        setPayloadForSelect,
      } = useContext(OnSearchContext);//new11
  ...
  //     mainFormData?.selectedGender || ""
  //   );
  const [selectedDate, setSelectedDate] = useState(
    mainFormData?.selectedDate || ""
  );
  // const genderMapping = {
  //   Male: 1,
  //   Female: 2,
  ...
  // };
  const genderMapping = { //new11 check it
        Male: 1,
        Female: 2,
        Other: 3,
    };
  ...
  //gernder function
  const [showSheetGender, setShowSheetGender] = useState(false);
  const [selectedGender, setSelectedGender] = useState(
    mainFormData?.selectedGender || ""
  );
  const handleSelectGenderType = (gender) => {
    setSelectedGender(gender);
    setFormData((prev) => ({
      ...prev,
      selectedGender: gender,
      genderValue: genderMapping[gender] || null, // Backend साठी integer value
    }));
    // setShowSheetGender(false);

    setTimeout(() => { // new add this three lines here
    setShowSheetGender(false);
  }, 4000);
  ...
  const validateAllFields = () => {
    ...
    const genderErr = validateField("gender", selectedGender); // selectedGender use करा
  ...
  // Capitalize first letter of each word while preserving natural typing
  value = value
    .split(' ')
    .map(word => {
  ...
  const isSelected = (day, isCurrentMonth) => {
    if (!isCurrentMonth || !selectedDate || !isValidDate(selectedDate))
      return false;
      ...
      const handleNext = async () => { // new11
          if (validateAllFields()) {
              try {
                  ...
                  setActiveContainer("NewPersonalDetailePage3");// new
          ...
          <div className={styles.form}>
            ...
            <div
              className={`${styles.fields} ${
                panError ? styles.fieldError : ""
              }`}
              onClick={() => handleBoxClick(panRef)}
            >
            ...
            <div
              ...
              onClick={() => handleBoxClick(nameRef)}
            >
            ...
            <div
              ...
              onClick={() => handleBoxClick(peremailRef)}
            >
            ...
            {/* <div className={styles.fields1}>
              ...
              <div className={styles.genderContainer}>
                <div
                  ...
                  } ${genderError ? styles.genderOptionError : ""}`}
                ...
                >
                  <div className={styles.genderIcon}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      ...
                      />
                      <path
                        d="M12 14C8.67 14 2 15.67 2 19V20C2 20.55 2.45 21 3 21H21C21.55 21 22 20.55 22 20V19C22 15.67 15.33 14 12 14Z"
                        fill="#6039d2"
                      />
                    </svg>
                  </div>
                ...
                >
                  <div className={styles.genderIcon}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      ...
                      />
                      <path
                        d="M12 14C9.5 14 7.5 14.5 6 15.5C5.5 15.8 5.2 16.3 5.2 16.9V17.5C5.2 18.3 5.9 19 6.7 19H8.5L9.5 21H14.5L15.5 19H17.3C18.1 19 18.8 18.3 18.8 17.5V16.9C18.8 16.3 18.5 15.8 18 15.5C16.5 14.5 14.5 14 12 14Z"
                        fill="#6039d2"
                      />
                    </svg>
                  </div>
            ...
            {/* Gender field with validation - REPLACE करा */}
            {/* <div
              className={`${styles.fields2} ${
                genderError ? styles.fieldserror : ""
              }`}
            >
              ...
              <div className={styles.inputWrapper}>
                <input
                  ...
                  readOnly
                  onClick={() => setShowSheetGender(true)}
                />
                <div
            ...
            >
              ...
              <div className={styles.inputWrapper}>
                <input
                  ...
                  className={styles.inputfield1}
                  readOnly
                  onClick={() => setShowSheetGender(!showSheetGender)}
                />
                <div
                  className={styles.iconContainer}
                  onClick={() => setShowSheetGender(!showSheetGender)}
              ...
              {showSheetGender && (
                <div className={styles.dropdownList}>
                  <div
                    ...
                    onClick={() => handleSelectGenderType("Male")}
                  >
                    Male
                  </div>
                  <div
                    ...
                    onClick={() => handleSelectGenderType("Female")}
                  >
                    Female
                  </div>
                  <div
                    ...
                    onClick={() =>
                      handleSelectGenderType("Prefer not to answer")
                    }
                  >
              ...
              {showSheetGender && (
                <>
                  ...
                  <div
                    ...
                    onClick={() => setShowSheetGender(false)}
                  ></div>
                  ...
                  <div className={styles.dropdownList}>
                    <div
                      ...
                      onClick={() => {
                        handleSelectGenderType("Male");
                        setShowSheetGender(false); // Close dropdown
                      }}
                    >
                      Male
                    </div>
            ...
            <div
              className={`${styles.fields} ${
                dobError ? styles.fieldError : ""
              }`}
              onClick={() => handleBoxClick(dobRef)}
            >
              ...
              <div className={styles.dobInputContainer}>
                ...
                >
                  <IoCalendarOutline className={styles.iconInput2} />
                </button>
              </div>
            </div>
              ...
              >
                ...
                <div
                  className={`${styles.sheetOption} ${
                    selectedGender === "Male" ? styles.sheetOptionSelected : ""
                  }`}
                  onClick={() => handleSelectGenderType("Male")}
                >
                  Male
                ...
                <div
                  ...
                  onClick={() => handleSelectGenderType("Prefer not to answer")}
                >
                  Prefer not to answer
                </div>
              </div>
...
export default NewPersonalDetailePage2;
