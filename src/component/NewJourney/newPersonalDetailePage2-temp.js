    ...
    if (validateAllFields()) {
      try {
        ...
        const payload = {
          ...
          firstName: fullName,
          email: email,
          gender: genderMapping[selectedGender], // Integer value backend साठी
          dob: selectedDate,
        };
        ...
        if (response.data.status === "APPROVED") {
          ...
          setFormData((prev) => ({
            ...
            email,
            selectedGender,
            genderValue: genderMapping[selectedGender],
            selectedDate,
          }));
          setActiveContainer("NewPersonalDetailePage3");
        } else {
